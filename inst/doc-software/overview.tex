...
\label{sec:orge28f076}

\subsection{Full information approach}
\label{sec:orgea2fb28}
...
\label{sec:orgb65a971}

\subsection{nlme package}
\label{sec:orgd8bd96e}
...
I summary.Wald_lmm(object = list(multivariate = list(type = c("mu",  :
  Columns "partial.r" and "partial.r2" may not have a simple interpretation.
\end{verbatim}
