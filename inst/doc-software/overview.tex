...
\label{sec:org942cde6}
\subsection{Summary statistics}
\label{sec:orgaf0fa3d}
...
\label{sec:orgb79bc20}
\subsection{Classical covariance patterns}
\label{sec:org8292ffa}
...
\label{sec:orgc984ae3}
\subsection{T-test}
\label{sec:org38a45eb}
A t-test:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:org168be0d}

\subsection{nlme package}
\label{sec:org5910f3c}
