...
\label{sec:org19326ec}
\subsection{Modeling tools}
\label{sec:org2447d4b}
...
parameters           : 5 mean ((Intercept) timeB1_week timeA1_week timeA3_months glucagon)
                       1 variance (sigma)                                                 
                       1 correlation (Rho)                                                
log-likelihood       : -243.600523870252
\end{verbatim}
...
\label{sec:org59bddaa}

\subsubsection{Model coefficients}
\label{sec:org3ce617f}
...
log(k).A3_months           0           0           0             0        0          0
                 log(k).B1_week log(k).A1_week log(k).A3_months atanh(cor(B1_week,B3_months))
log(k).B1_week                1              0                0                             0
log(k).A1_week                0              1                0                             0
log(k).A3_months              0              0                1                             0
                 atanh(cor(A1_week,B3_months)) atanh(cor(A3_months,B3_months))
log(k).B1_week                               0                               0
log(k).A1_week                               0                               0
log(k).A3_months                             0                               0
                 atanh(cor(A1_week,B1_week)) atanh(cor(A3_months,B1_week))
log(k).B1_week                             0                             0
log(k).A1_week                             0                             0
log(k).A3_months                           0                             0
                 atanh(cor(A3_months,A1_week))
log(k).B1_week                               0
log(k).A1_week                               0
log(k).A3_months                             0
\end{verbatim}
...
\begin{verbatim}
 ...
 2 - 1    B1_week       5.80  9.38 18.0    -15.4     27.0   0.618  0.6480
 2 - 1    A1_week       4.29  9.11 18.0    -16.3     24.9   0.471  0.7554
...
\begin{itemize}
\item \textbf{dynamic predictions} that are also conditional on the outcome
measured at other timepoints. Consider
\end{itemize}

\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none,otherkeywords={}, deletekeywords={}}
\begin{lstlisting}
newd <- rbind(data.frame(id = 1, time = "B3_months", weight = coef(eCS.lmm)["(Intercept)"], glucagon = 0),
	      data.frame(id = 1, time = "B1_week", weight = NA, glucagon = news[1,"glucagon"]),
	      data.frame(id = 2, time = "B3_months", weight = 130, glucagon = 0),
	      data.frame(id = 2, time = "B1_week", weight = NA, glucagon = news[1,"glucagon"]))
...
2  1   B1_week       NA        0 121.7496 1.046825 Inf 119.6979 123.8013
3  2 B3_months 130.0000        0       NA       NA  NA       NA       NA
4  2   B1_week       NA        0 122.3615 1.053642 Inf 120.2964 124.4266
\end{verbatim}
...
other attached packages:
 [1] emmeans_1.6.3     LMMstar_0.2.6     nlme_3.1-152      spelling_2.2      roxygen2_7.1.1   
 [6] butils.base_1.2   Rcpp_1.0.7        data.table_1.14.0 devtools_2.4.2    usethis_2.0.1    

loaded via a namespace (and not attached):
 [1] mvtnorm_1.1-2       lattice_0.20-44     prettyunits_1.1.1   ps_1.6.0           
 [5] zoo_1.8-9           digest_0.6.27       rprojroot_2.0.2     utf8_1.2.2         
 [9] plyr_1.8.6          R6_2.5.1            coda_0.19-4         ggplot2_3.3.5      
[13] pillar_1.6.2        rlang_0.4.11        multcomp_1.4-17     callr_3.7.0        
[17] Matrix_1.3-4        labeling_0.4.2      desc_1.3.0          splines_4.1.1      
[21] stringr_1.4.0       munsell_0.5.0       numDeriv_2016.8-1.1 compiler_4.1.1     
[25] xfun_0.25           pkgconfig_2.0.3     pkgbuild_1.2.0      tidyselect_1.1.1   
[29] tibble_3.1.4        codetools_0.2-18    fansi_0.5.0         crayon_1.4.1       
[33] dplyr_1.0.7         withr_2.4.2         MASS_7.3-54         grid_4.1.1         
[37] xtable_1.8-4        gtable_0.3.0        lifecycle_1.0.0     magrittr_2.0.1     
[41] scales_1.1.1        estimability_1.3    cli_3.0.1           stringi_1.7.4      
[45] cachem_1.0.6        farver_2.1.0        reshape2_1.4.4      fs_1.5.0           
[49] remotes_2.4.0       testthat_3.0.4      xml2_1.3.2          ellipsis_0.3.2     
[53] vctrs_0.3.8         generics_0.1.0      sandwich_3.0-1      TH.data_1.0-10     
[57] lava_1.6.9          tools_4.1.1         glue_1.4.2          purrr_0.3.4        
[61] processx_3.5.2      pkgload_1.2.1       fastmap_1.1.0       survival_3.2-11    
