...
\label{sec:org8605f5d}
\subsection{Modeling tools}
\label{sec:org8dd42e7}
...
\begin{verbatim}
 ...
 convergence         : TRUE (26 iterations)
 covariance structure: 
          B3_months  B1_week  A1_week A3_months
...
\begin{verbatim}
 ...
 log-restr.likelihood: -205.26832084513 
...
Estimation procedure 
  ...
  - log-restricted likelihood :-216.3189
  - parameters: mean = 5, variance = 4, correlation = 6
  - convergence: TRUE (26 iterations, largest |score|=4.315158e-06 is for k.A1_week)
...
128.5385950    -7.8822331   -11.7879541   -26.1223907    -0.8883083
\end{verbatim}
...
4       4  -1.6403081 -0.5128371  0.06806212   1.1725813
...
time      86.74279      3 19.00520 2.842460e-11
glucagon  13.51775      1 13.70749 2.571625e-03
\end{verbatim}
...
\begin{verbatim}
 ...
 - P-values and confidence interval 
                           estimate        se       df     lower     upper      p.value
timeA1_week - timeB1_week -3.905721 0.5946403 17.87455 -5.155643 -2.655799 3.723358e-06
\end{verbatim}
...
\begin{verbatim}
 ...
 - F-test:
 statistic df.num df.denom      p.value
  98.65053      2 18.61992 1.233819e-10

 - P-values and confidence interval (adjusted for multiplicity) 
                              estimate        se df      lower      upper      p.value
timeA1_week - timeB1_week    -3.905721 0.5946403 20  -5.306911  -2.504531 4.080425e-06
timeA3_months - timeB1_week -18.240158 1.3228299 20 -21.357228 -15.123087 2.195177e-11
\end{verbatim}
...
Singular contrast matrix: contrasts "A1_week - B1_week" "A3_months - B1_week" "A3_months - A1_week" have been removed. 
 ...
 - F-test:
 statistic df.num df.denom     p.value
  86.74279      3  19.0052 2.84246e-11

 - P-values and confidence interval (adjusted for multiplicity) 
                        estimate        se df      lower      upper      p.value
B1_week - B3_months    -7.882233 0.7131797 22  -9.784489  -5.979977 8.137047e-12
A1_week - B3_months   -11.787954 1.0175135 22 -14.501956  -9.073953 4.271916e-12
A3_months - B3_months -26.122391 1.6564077 22 -30.540507 -21.704274 0.000000e+00
A1_week - B1_week      -3.905721 0.5946403 22  -5.491798  -2.319644 4.898696e-06
A3_months - B1_week   -18.240158 1.3228299 22 -21.768526 -14.711789 4.718448e-14
A3_months - A1_week   -14.334437 1.0565002 22 -17.152427 -11.516446 4.263256e-14
\end{verbatim}
...
e.lmmANCOVA <- lmm(weight ~ time+time:group, repetition = ~time|id,
		   data = gastricbypassL[gastricbypassL$visit %in% c("2","3"),])
\end{lstlisting}
...
\begin{verbatim}
    estimate         se       df      lower    upper   p.value
Y1 0.9654917 0.01753161 15.96769  0.9283202 1.002663 0.0000000
X1 0.2521713 0.64626330 15.00349 -1.1252784 1.629621 0.7018732
\end{verbatim}


Indeed:
\begin{align*}
\Esp[Y_{i2}|Y_{i1},X_{i}] &= \alpha_j + \gamma_j X_{i} + \rho \frac{\sigma_2}{\sigma_1}\left(Y_{i1} - \alpha_j - \gamma_j X_{i}\right) \\
                         &= \textcolor{\darkred}{\alpha_j - \rho \frac{\sigma_2}{\sigma_1} \alpha_j}
                         + \textcolor{\darkblue}{\rho \frac{\sigma_2}{\sigma_1}Y_{i1}}
                         + \textcolor{\darkgreen}{\left(\gamma_j - \rho \frac{\sigma_2}{\sigma_1} \gamma_j\right)  X_{i} }
\end{align*}
...
\begin{verbatim}
 ...
 2 - 1    B1_week       5.80  9.38 18.0    -15.4     27.0   0.618  0.6476
 2 - 1    A1_week       4.29  9.11 18.0    -16.3     24.9   0.471  0.7553
 2 - 1    A3_months     6.69  8.40 18.1    -12.3     25.7   0.797  0.5279
...
2  1   B1_week       NA        0 120.65636 0.6361009 Inf 119.40963 121.9031
...
\begin{verbatim}
   id visit      time weight   glucagon group treat treat2 imputed    estimate
5   5     1 B3_months  113.1 -0.6162619     1  none      1   FALSE -0.48564787
15 15     1 B3_months  115.0 -0.9012594     2  none      1   FALSE -0.48564787
25  5     2   B1_week  105.6 -0.7430158     1  none      1    TRUE -0.61323797
35 15     2   B1_week  109.7 -0.4903032     2  none      1   FALSE -0.61323797
45  5     3   A1_week   99.9  1.4303759     1     1      1   FALSE  1.07898563
55 15     3   A1_week  103.5  1.4978616     2     2      2    TRUE  1.07898563
65  5     4 A3_months   87.7  0.2751184     1     1      1   FALSE  0.05764249
75 15     4 A3_months   94.1  1.2596319     2     2      2   FALSE  0.05764249
\end{verbatim}
...
\begin{verbatim}
[1] -0.7375653  1.3052918
[1] -1.1417336  0.8716473
[1] -0.657376  1.905251
\end{verbatim}
