...
\label{sec:org7f830f6}
\subsection{Modeling tools}
\label{sec:orgff95d49}
...
weight/id/time                                                                                                                                           
78 observations and distributed in 20 clusters                                                                                                           
5 mean ((Intercept) timeB1_week timeA1_week timeA3_months glucagon)                                                                                      
...
\label{sec:org7021818}

\subsubsection{Model coefficients}
\label{sec:orgec828f3}
...
timeA1_week - timeB1_week -3.905721 -5.155641 -2.655801 3.723244e-06
\end{verbatim}
...
\begin{verbatim}
Fejl i pdf(file = "./figures/gg-baseAdj.pdf") : 
  kan ikke åbne fil './figures/gg-baseAdj.pdf'
, , group = 1
...
\begin{verbatim}
 ...
 2 - 1    A1_week       4.29  9.11 18.0    -16.3     24.9   0.471  0.7550
 2 - 1    A3_months     6.69  8.40 18.1    -12.3     25.7   0.797  0.5281
...
[1] emmeans_1.6.3 LMMstar_0.2.6 nlme_3.1-152  ggplot2_3.3.5

loaded via a namespace (and not attached):
 [1] Rcpp_1.0.7          plyr_1.8.6          pillar_1.6.2        compiler_4.1.1     
 [5] tools_4.1.1         digest_0.6.27       lifecycle_1.0.0     tibble_3.1.4       
 [9] gtable_0.3.0        lattice_0.20-44     pkgconfig_2.0.3     rlang_0.4.11       
[13] Matrix_1.3-4        mvtnorm_1.1-2       coda_0.19-4         stringr_1.4.0      
[17] withr_2.4.2         dplyr_1.0.7         generics_0.1.0      vctrs_0.3.8        
[21] grid_4.1.1          tidyselect_1.1.1    glue_1.4.2          R6_2.5.1           
[25] fansi_0.5.0         survival_3.2-11     multcomp_1.4-17     lava_1.6.9         
[29] TH.data_1.0-10      farver_2.1.0        reshape2_1.4.4      purrr_0.3.4        
[33] magrittr_2.0.1      scales_1.1.1        codetools_0.2-18    ellipsis_0.3.2     
[37] splines_4.1.1       MASS_7.3-54         colorspace_2.0-2    xtable_1.8-4       
[41] numDeriv_2016.8-1.1 labeling_0.4.2      sandwich_3.0-1      utf8_1.2.2         
[45] stringi_1.7.4       estimability_1.3    munsell_0.5.0       crayon_1.4.1       
[49] zoo_1.8-9
\end{verbatim}
