...
\label{sec:orga9a39a4}
\subsection{Summary statistics}
\label{sec:orgdd5d996}
...
\label{sec:orgac3240d}
\subsection{Classical covariance patterns}
\label{sec:org3b3532b}
...
\label{sec:orgcccb7db}
\subsection{T-test}
\label{sec:orgdce2c85}
A t-test:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:orgb933d1a}

\subsection{nlme package}
\label{sec:orgc23f0da}
