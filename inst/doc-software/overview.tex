...
\label{sec:org9ed96a2}
\subsection{Summary statistics}
\label{sec:orgc25e120}
...
\label{sec:org8c6c233}
\subsection{Classical covariance patterns}
\label{sec:org6097366}
...
\label{sec:org7569661}
\subsection{T-test}
\label{sec:org825fd1c}
A t-test:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:org9486662}

\subsection{nlme package}
\label{sec:org5130c41}
