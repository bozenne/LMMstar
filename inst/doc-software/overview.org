...
range(ranef(e.lmer)[[1]][,1]-ranef(eCS.lmm)$estimate)
...
#+begin_example
  ...
  Degrees of freedom were computed using a Satterthwaite approximation (column df). 
		...
		Univariate Wald test 
                     ...
                     estimate    se   df   lower   upper p.value    
   timeA1w - timeB1w   -3.906 0.595 17.9  -5.325  -2.486  <1e-05 ***
   timeA3m - timeB1w   -18.24 1.323   19 -21.398 -15.083  <1e-05 ***
   --------------------------------------------------------------- 
  Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1.
...
:   lmm 154.5435 163.3803 168.12818 166.68985 172.8021 190.9734    50 a  
:  lmm0  70.6504  73.2240  83.42176  76.96115  82.5822 324.1908    50  b 
:  mmrm  30.1044  30.5351  32.60750  31.45955  32.4190  48.7795    50   c
