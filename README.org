...
#+BEGIN_SRC R :exports both :results output :session *R* :cache no
getCoef(e.lmm, effects = c("variance"))
#+END_SRC

#+RESULTS:
#+begin_example
        type     term  estimate  conf.low conf.high
1  corStruct cor(1,2) 0.9097688 0.8824279 0.9309847
2  corStruct cor(1,3) 0.9035667 0.8744735 0.9261826
3  corStruct cor(1,4) 0.9117360 0.8849552 0.9325058
4  corStruct cor(2,3) 0.9012888 0.8715746 0.9244055
5  corStruct cor(2,4) 0.9056975 0.8772191 0.9278244
6  corStruct cor(3,4) 0.9007434 0.8708749 0.9239837
7  varStruct        2 0.9995212 0.9431565 1.0592543
8  varStruct        3 0.9568404 0.9015721 1.0154968
9  varStruct        4 0.9897593 0.9349787 1.0477495
10     sigma    sigma 3.3371484 3.0232083 3.6836891
#+end_example
