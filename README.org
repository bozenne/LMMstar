...
#+BEGIN_SRC R :exports none :results output :session *R* :cache no
ggsave(gg, filename = "c:/Users/hpl802/Documents/GitHub/repeated/inst/figures/gg-ufit.pdf")
#+END_SRC

#+RESULTS:
: Saving 7 x 7 in image

#+html: <p align="center"><img src="inst/figures/gg-ufit.pdf" /></p>
